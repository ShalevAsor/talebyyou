...
import BookTemplatePreviewClient from "@/components/templates/template-preview/BookTemplatePreviewClient";
...
export async function generateMetadata({ params }: TemplatePreviewPageProps) {
  ...
  try {
    ...
    return createMetadata({
      ...
      other: {
        // Pinterest Rich Pin product meta tags
        "og:type": "product",
        "og:price:amount": "34.99",
...
export default async function BookPreviewPage({
  ...
  try {
    ...
    if (!templateResult.success) {
      ...
      logger.error(
        { templateSlug: slug, error: templateResult.error },
    ...
    const processedTemplate = processBookTemplateForPreview(
      originalTemplate,
      undefined,
      undefined,
      originalTemplate.characterGender
    );
      ...
      <>
        ...
        <PageHeader
          ...
          actions={[
            ...
            },
            {
              ...
              href: `/library/customize/${processedTemplate.slug}`,
              variant: "default",
              size: "sm",
              icon: <FiEdit3 />,
        ...
        >
          ...
          <div className="p-6">
            ...
            >
              <BookTemplatePreviewClient bookTemplate={processedTemplate} />
            </Suspense>
          </div>
        </section>
