...
//   // Check if this book belongs to the user (if logged in)
//   // For guest books, userId will be null
//   if (user && book.userId && book.userId !== user.id) {
//     redirect("/my-books");
//   }

//   // Look up if there's an existing order for this book
//   const existingOrder = book.order;

//   // If there's an order that's not in PENDING status, we shouldn't allow
//   // modification through this page
