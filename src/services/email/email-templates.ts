...
export const getWelcomeEmailTemplate = (userName: string): string => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #4F46E5;">Welcome to TaleByYou!</h2>
      <p>Hello ${userName},</p>
      ...
      <p style="color: #999; font-size: 12px;">© ${new Date().getFullYear()} TaleByYou. All rights reserved.</p>
    </div>
  `;
};

/**
 * Generate an order confirmation email template for personalized books
 * @param userName The user's name
...
export const getBookCompletionEmailTemplate = (
  ...
  return `
    ...
    productType === ProductType.BOOK ? " and has been sent for printing" : ""
      ...
      <hr style="border: 1px solid #eee; margin: 20px 0;" />
      <p style="text-align: center; margin: 20px 0;">Thank you for creating with TaleByYou!</p>
      <p style="color: #999; font-size: 12px; text-align: center;">© ${new Date().getFullYear()} TaleByYou. All rights reserved.</p>
    </div>
  `;
};
