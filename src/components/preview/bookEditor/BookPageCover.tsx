...
//   ({ children, isLastPage, coverImage, coverDedication }, ref) => {
//     // Get edit mode state and currentlyEditing from the store
...
//               {coverDedication ? (
//                 <div className="text-center text-gray-800 italic text-base leading-relaxed fade-in max-h-[120px] overflow-y-auto break-words whitespace-pre-wrap">
...
// BookPageCover.displayName = "PageCover";
