...
//         className={`w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none ${getEditorStyles()}`}
//         style={{ minHeight }}
//       />
...
//           <button
//             onClick={onCancel}
//             className="flex items-center px-3 py-1.5 rounded-md bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors"
//             aria-label="Cancel"
//           >
//             <FiX className="mr-1" />
//             Cancel
...
//           <button
//             onClick={handleSave}
//             className="flex items-center px-3 py-1.5 rounded-md bg-blue-600 text-white hover:bg-blue-700 transition-colors"
//             aria-label="Save"
//           >
