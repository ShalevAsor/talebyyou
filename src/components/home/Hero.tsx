...
//               <span>Personalized Reading Adventures</span>
//             </div>
...
//                   ></span>
//                 </span>{" "}
//                 <span className="text-indigo-600">Storybooks</span>
//                 <span className="block mt-1">For Your Little Heroes</span>
//               </h1>

//               <p className="text-lg md:text-xl text-slate-600 max-w-md">
//                 Beautifully crafted personalized books that transform your child
//                 into the main character of magical adventures, creating a love
//                 for reading that lasts a lifetime.
//               </p>
//             </div>

//             {/* Call to Action Buttons - Using Shadcn/UI asChild pattern */}
...
//             {/* Stats - Using data from siteConfig */}
//             <div className="grid grid-cols-3 gap-8 pt-4">
//               <div className="bg-indigo-50 rounded-lg p-4 text-center">
//                 <div className="font-bold text-indigo-600 text-2xl mb-1">
//                   10+
//                 </div>
//                 <div className="text-slate-700 text-sm">Story Themes</div>
//               </div>
...
//                   Fast
//                 </div>
//                 <div className="text-slate-700 text-sm">Delivery</div>
//               </div>
//             </div>
//           </div>
...
//             {/* Gradient Background Behind Image Card */}
//             <div
...
//               {/* Book Image - Using image path from siteConfig */}
