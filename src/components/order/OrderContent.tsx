...
//     // Save form data
//     setFormData(data);
//     // Calculate total cost for ebooks immediately
//     if (data.productType === ProductType.EBOOK) {
//       setTotalCost(getProductPrice(data.productType).toString());
//     }
//     // Create or update the order, passing the quantity from the store
//     if (orderId) {
//       // Pass the store's quantity as an additional parameter
...
//       // Calculate the total price we charge to the customer
...
//       setShippingDetails(level, shippingCostValue, totalPrice);
...
//   // If still initializing, show a loading state
//   if (isInitializing ) {
//     return (
