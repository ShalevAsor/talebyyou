// // src/components/admin/webhooks/WebhookManagement.tsx
// "use client";
...
//             <Badge
//               variant={webhook && webhook.is_active ? "success" : "destructive"}
//             >
...
//                 <span className="col-span-2">{webhook.topics.join(", ")}</span>
//               </div>
//               <div className="grid grid-cols-3 gap-1">
...
//           >
//             {loading.setup && <Loader2 className="h-4 w-4 mr-2 animate-spin" />}
...
//                 variant="outline"
//                 onClick={testWebhook}
//                 disabled={loading.test || !webhook.is_active}
//               >
//                 {loading.test && (
