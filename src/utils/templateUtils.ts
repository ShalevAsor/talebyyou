...
export const replaceCharacterPlaceholders = (
  ...
  const placeholders: Record<string, string> = {
    ...
    "[BOY_GIRL]": genericGender === "boy" ? "boy" : "girl",
    "[BROTHER_SISTER]": genericGender === "boy" ? "brother" : "sister",
    "[SON_DAUGHTER]": genericGender === "boy" ? "son" : "daughter",
  };
  ...
  // Fix capitalization at the beginning of sentences (same as in book creation service)
