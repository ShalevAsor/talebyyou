...
//     // Get additional copy price from pricing config or fallback to constant
//     const additionalCopyPrice = pricing?.additionalCopyPrice
//       ? typeof pricing.additionalCopyPrice === "string"
//         ? parseFloat(pricing.additionalCopyPrice)
//         : pricing.additionalCopyPrice
//       : BOOK_PRICES.base; // Fallback to constant
...
//  * New function to get comprehensive pricing breakdown
//  */
